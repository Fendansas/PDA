...
public class HPlayerPersistency implements PlayerPersistency
{
    ...
    {
        fractions.put("MONOLITH5323", Player.FRACTION.MONOLITH); //Режим монолитовца
        fractions.put("GAMEMASTER5123", Player.FRACTION.GAMEMASTER); //Режим игромастера
        fractions.put("STALKER8223", Player.FRACTION.STALKER); //Режим обычного игрока
        fractions.put("DARKEN5623", Player.FRACTION.DARKEN); //Режим Тёмного

    }
    private void setupCommands()
    {
        commands.put("KILL9223", Player.COMMAND.KILL); //Убить игрока
        commands.put("REVIVE5623", Player.COMMAND.REVIVE); //Оживить игрока
    }
