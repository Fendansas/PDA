...
//MEDKITS (Аптечки)
        possibleItems.put ("Bandage8723", (new ItemDescriptorImpl(MEDKITS, R.string.item_bandage)) //Бинт
                .setImage(R.drawable.item_bandage)
                .setArtefact(false)
                .addModifier(Item.HEALTH_INSTANT, 10d)
                .setDescription(R.string.desc_bandage)
        );
        possibleItems.put("Medkit5923", (new ItemDescriptorImpl(MEDKITS, R.string.item_medkit)) //Аптечка
                .setImage(R.drawable.item_medkit)
                .setArtefact(false)
                .addModifier(Item.HEALTH_INSTANT, 20d)
                .setDescription(R.string.desc_medkit)
        );
        possibleItems.put("ArmyMedkit8923", (new ItemDescriptorImpl(MEDKITS, R.string.item_army_medkit)) //Армейская аптечка
                .setImage(R.drawable.item_army_medkit)
                .setArtefact(false)
                .addModifier(Item.HEALTH_INSTANT, 30d)
                .setDescription(R.string.desc_army_medkit)
        );
        possibleItems.put("Vinca6923", (new ItemDescriptorImpl(MEDKITS, R.string.item_vinca)) //Таблетки Барвинок
        ...
        possibleItems.put("ScientificMedkit5623", (new ItemDescriptorImpl(MEDKITS, R.string.item_scientific_medkit)) //Научная аптечка
        ...
        possibleItems.put("Vodka4523", (new ItemDescriptorImpl(ANTIRADS, R.string.item_vodka)) //Водка Казаки
        ...
        possibleItems.put("AntiRad5323", (new ItemDescriptorImpl(ANTIRADS, R.string.item_antirad)) //Антирад
        ...
        possibleItems.put("Anabiotic5923", (new ItemDescriptorImpl(ANTIRADS, R.string.item_anabiotic)) //Анабиотик
...
//BOOSTERS (Бустеры)
        possibleItems.put("B190Radioprotectant6323", (new ItemDescriptorImpl(BOOSTERS, R.string.item_b190)) //Радиопротектор Б190
        ...
        possibleItems.put("PsyBlock2623", (new ItemDescriptorImpl(BOOSTERS, R.string.item_psyblock)) //Пси-блокада
        ...
        possibleItems.put("IP2Antidote5823", (new ItemDescriptorImpl(BOOSTERS, R.string.item_ip2)) //Антидот ИП2
        ...
        possibleItems.put("GreenSvobodaSerum8523", (new ItemDescriptorImpl(BOOSTERS, R.string.item_green_svoboda)) //Настойка Радвинок
        ...
        possibleItems.put("YellowSvobodaSerum6323", (new ItemDescriptorImpl(BOOSTERS, R.string.item_yellow_svoboda)) //Настойка Менвинок
...
//FILTERS (Фильтры)
        possibleItems.put("Respirator5923", (new ItemDescriptorImpl(FILTERS, R.string.item_respirator)) //Респиратор
        ...
        possibleItems.put("Gasmask5923", (new ItemDescriptorImpl(FILTERS, R.string.item_gasmask)) //Противогаз
        ...
        possibleItems.put("Rebreather8423", (new ItemDescriptorImpl(FILTERS, R.string.item_szd)) //Система замкнутого дыхания
...
//DEVICES (Приборы)
        possibleItems.put("PsionicHelmetMark6923", (new ItemDescriptorImpl(DEVICES, R.string.item_shlem1)) //Пси-шлем М1
        ...
        possibleItems.put("PsionicHelmetMark8523", (new ItemDescriptorImpl(DEVICES, R.string.item_shlem2)) //Пси-шлем М2
...
//SUITS (Комбезы)
//SIMPLE (Простые)
        possibleItems.put("LeatherJacket4123", (new ItemDescriptorImpl(ARMORS, R.string.item_leather_jacket)) //Кожаная куртка
        ...
        possibleItems.put("SSP99Ecologist5123", (new ItemDescriptorImpl(ARMORS, R.string.item_ssp99)) //Комбинезон Эколог
...
//ADVANCED (Улучшенные)
        possibleItems.put("StalkerSuit8723", (new ItemDescriptorImpl(ARMORS, R.string.item_stalker_suit)) //Комбез сталкера Заря
        ...
        possibleItems.put("SEVASuit2823", (new ItemDescriptorImpl(ARMORS, R.string.item_seva_suit)) //Комбинезон СЕВА
        ...
        possibleItems.put("Exoskeleton4823", (new ItemDescriptorImpl(ARMORS, R.string.item_exoskeleton)) //Экзоскелет
...
//FRACTIONAL (Фракционные)
        possibleItems.put("BerillSuit2623", (new ItemDescriptorImpl(ARMORS, R.string.item_berill_suit)) //Бронекостюм Берилл
        ...
        possibleItems.put("MercSuit5623", (new ItemDescriptorImpl(ARMORS, R.string.item_merc_suit)) //Комбез наёмника
        ...
        possibleItems.put("DutySuit5823", (new ItemDescriptorImpl(ARMORS, R.string.item_duty_suit)) //Комбез Долга
        ...
        possibleItems.put("FreedomSuit2823", (new ItemDescriptorImpl(ARMORS, R.string.item_freedom_suit)) //Комбез Свободы
        ...
        possibleItems.put("ClearSkySuit5723", (new ItemDescriptorImpl(ARMORS, R.string.item_clearsky_suit)) //Комбез Чистого Неба
        ...
        possibleItems.put("BanditSuit5823", (new ItemDescriptorImpl(ARMORS, R.string.item_bandit_suit)) //Плащ бандита
        ...
        possibleItems.put("MonolithSuit6923", (new ItemDescriptorImpl(ARMORS, R.string.item_monolith_suit)) //Комбез Монолита
...
//FOOD (Еда)
        possibleItems.put("DeadRat8423", (new ItemDescriptorImpl(FOOD, R.string.item_dead_rat)) //Дохлая крыса
        ...
        possibleItems.put("Bread9523", (new ItemDescriptorImpl(FOOD, R.string.item_bread)) //Батон
        ...
        possibleItems.put("Sausage2423", (new ItemDescriptorImpl(FOOD, R.string.item_sausage)) //Колбаса
        ...
        possibleItems.put("CannedMeat4823", (new ItemDescriptorImpl(FOOD, R.string.item_canned_meat)) //Консерва
        ...
        possibleItems.put("Doktorskaja4823", (new ItemDescriptorImpl(FOOD, R.string.item_doktorskaja)) //Докторская
        ...
        possibleItems.put("Delikates4823", (new ItemDescriptorImpl(FOOD, R.string.item_delikates)) //Деликатес
        ...
        possibleItems.put("Hercules5923", (new ItemDescriptorImpl(FOOD, R.string.item_hercules)) //Геркулес
        ...
        possibleItems.put("EnergyDrink6323", (new ItemDescriptorImpl(FOOD, R.string.item_energy_drink)) //Энергетик Сталкер
        ...
        possibleItems.put("RedDevil3423", (new ItemDescriptorImpl(FOOD, R.string.item_red_devil)) //Левый энергетик
...
//HABAR (Хабар)
        possibleItems.put("Garmoshka85323", (new ItemDescriptorImpl(HABAR, R.string.item_garmoshka)) //Губная гармошка
        ...
        possibleItems.put("Bag85323", (new ItemDescriptorImpl(HABAR, R.string.item_bag)) //Спальный мешок
        ...
        possibleItems.put("Gasoline85323", (new ItemDescriptorImpl(HABAR, R.string.item_gasoline)) //Канистра бензина
        ...
        possibleItems.put("Maps85323", (new ItemDescriptorImpl(HABAR, R.string.item_maps)) //Старая карта
        ...
        possibleItems.put("Guitar45823", (new ItemDescriptorImpl(HABAR, R.string.item_guitar)) //Потрёпанная гитара
        ...
        possibleItems.put("Instruments19323", (new ItemDescriptorImpl(HABAR, R.string.item_instruments)) //Ящик с инструментами
        ...
        possibleItems.put("UnknownDevice91723", (new ItemDescriptorImpl(HABAR, R.string.item_psionic_device)) //Непонятный прибор
        ...
        possibleItems.put("InfoPDA45823", (new ItemDescriptorImpl(HABAR, R.string.item_pda)) //ПДА с важной инфой
        ...
        possibleItems.put("Calibrating0223", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_10)) //-10% к некоторым угрозам
        ...
        possibleItems.put("Calibrating5723", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_25)) //-25% к некоторым угрозам
        ...
        possibleItems.put("Calibrating0823", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_50)) //-50% к некоторым угрозам
        ...
        possibleItems.put("Calibrating5323", (new ItemDescriptorImpl(DEVICES, R.string.item_calibrating_75)) //-99,9% к некоторым угрозам
...
//        level1.add(makeLevelItem2(R.string.item_9mm, R.string.desc_9mm, R.drawable.item_9mm));
        level1.add(makeLevelItem3(R.string.item_bread, R.string.desc_bread, R.drawable.item_bread));
...
//    }
    ...
    private ItemDescriptor makeLevelItem2(int title, int description, int image)
   {
    ...
    private ItemDescriptor makeLevelItem3(int title, int description, int image)
    {
        
            return (new ItemDescriptorImpl(FOOD, R.string.item_bread)
                    .setImage(R.drawable.item_bread)
                    .setArtefact(false)
                    .addModifier(Item.HEALTH_INSTANT, 3d)
                    .setXpPoints(1)
